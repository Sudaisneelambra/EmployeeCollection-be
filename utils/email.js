...
const sendEmail = async (email, subjectSend,username, userpass,userid) => {
  try {
    ...
    <ul>
      ...
      <li><span style="color: #336699;">Password:</span> <strong> ${userpass} </strong></li>
       <li><span style="color: #336699;">uniqueID:</span> <strong> ${userid} </strong></li>
    </ul>
    <p>Welcome aboard!</p>

    <p><span style="color: #336699; font-style: italic;">Best regards,</span></p>
    <p><span style="color: #336699; font-weight: bold;">The Cordova Team</span></p>`,
    });
  } catch (error) {
    throw error
  }
